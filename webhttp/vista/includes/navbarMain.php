...
-->
        ...
        <a class="btn" href="#log" data-bs-toggle="collapse" aria-expanded="false" role="button">Login</a>
            <!-- login card  btn-bootstrap navbar-toggler collapsed-->
                                ...
                                <div class="container py-11 h-100">
                                    <div class="col card-header text-center">
                                        <a id="link-hover" href="../../index2.html"
                                            class="h1 text-center card-title col"><b>Love</b>You</a>
                                        <br>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <form action="../web/cmdAutenticar" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit"
                                                        class="btn  btn-outline-dark btn-block" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-border-color: #58151c; --bs-btn-color: #58151c; --bs-btn-hover-bg: #58151c;">Ingresar</button>
                                                </div>
                                                <!-- /.col -->
                                            </div>
                                        </form>
