                        ...
                        <div class="card">
                            ...
                            <div class="p-4 text-black" style="background-color: #f8f9fa;">
                                <div>
                                    ...
                                    print_r('<a class="btn btn-outline-dark" href="..\LoveYou/web/cmdPerfilPublico/' . $Id . ' " role="button"> Perfil Publico </a>'); 
                                    ?>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="p-4" style="background-color: #f8f9fa;">
                                        ...
                                        <label for="fname">Nombre:</label>
                                            ...
                                            <?php print_r( "<label id='identificacion' class='text-secondary'>".$d->data[0]->Tipo_Identificacion . " " . $d->data[0]->Numero_Identificacion."</label>" ); ?><br>
                                            ...
                                            <?php print_r( "<label id='Direccion' class='text-secondary'>".$d->data[0]->Ciudad_Residencia . " " . $d->data[0]->Calle_Principal. " " .$d->data[0]->Calle_Secundaria."</label>" ); ?><br>
                                            ...
                                            <?php print_r("<label id='Teléfono' class='text-secondary'>".$d->data[0]->Telefono . "</label>"); ?><br>
                                            
                                            <label for="Email">Email:</label>
                                            <?php print_r( "<label id='Email' class='text-secondary'>".$d->data[0]->Email."</label>"); ?>
                                        </p>
