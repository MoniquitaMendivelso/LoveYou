...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" id="Registro-background">
            ...
            <section class="col-5">
                ...
                <div class="container py-5 h-100" id="Colorbox">
                    <div class=" card-header text-center">
                        <h1 class="h1" id="link-hover"><b>Crear Usuario</b></h1>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->

                    <form action="<?php print_r('web/cmdCrearUsuario/' . $d->data[0]->Id_Usuario); ?>" method="POST">
                        <div class="card-body">
